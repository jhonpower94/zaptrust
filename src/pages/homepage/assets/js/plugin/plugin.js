$(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    $(".partner-carousel").slick({
      ...
      arrows: false,
      prevArrow:
        "<button type='button' class='slick-prev pull-left'><i class=\"icon-double-left\"  aria-hidden='true'></i></button>",
      nextArrow:
        "<button type='button' class='slick-next pull-right'><i class=\"icon-double-right\"  aria-hidden='true'></i></button>",
      dots: false,
    ...
    if (document.querySelector("#down-payment-slide") !== null) {
      ...
      $("#down-payment-amount").val(
        " $" + $("#down-payment-slide").slider("value")
      );
    }
